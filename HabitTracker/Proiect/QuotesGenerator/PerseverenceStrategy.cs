...
{
    public class PerseverenceStrategy : MotivatorStrategy
    {
        public void buildMotivation(string text)
        {
            var quote = Proiect.QuotesAPIManager.GetQuote(QuotesAPIManager.Topics.courage);
