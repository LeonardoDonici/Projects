/**************************************************************************
 *                                                                        *
 *  File:        TransformationStrategy.cs                                *
...
{
    public class TransformationStrategy : MotivatorStrategy
    {
        public void buildMotivation(string text)
        {
            var quote = Proiect.QuotesAPIManager.GetQuote(QuotesAPIManager.Topics.change);
