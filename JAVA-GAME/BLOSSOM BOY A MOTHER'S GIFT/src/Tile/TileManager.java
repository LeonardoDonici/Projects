...
public class TileManager {
    ...
    public TileManager(GamePanel gp) throws Invalid_IMAGE_Exception {
    ...
    public void getTileImage() throws Invalid_IMAGE_Exception{
        ...
        try{
                ...
                tile[4] = new Tile();
                tile[4].image = ImageIO.read(getClass().getResourceAsStream("/tiles/floor.jpg"));


                tile[5] = new Tile();
                tile[5].image = ImageIO.read(getClass().getResourceAsStream("/tiles/cement.png"));
